...
if uploaded_file is not None:
    ...
    models.append(('Exp_Smoothing', ExponentialSmoothing(trend="add", seasonal="multiplicative")))
    ...
    def select_regressor(selection):
        ...
        'Exp_Smoothing': ExponentialSmoothing(trend="add", seasonal="multiplicative"),
