...
if uploaded_file is not None:
    ...
    models.append(('Exp_Smoothing', ExponentialSmoothing(trend="mul", seasonal="multiplicative", sp=6)))
    ...
    def select_regressor(selection):
        ...
        'Exp_Smoothing': ExponentialSmoothing(trend="mul", seasonal="multiplicative",sp=6),
