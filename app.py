...
if uploaded_file is not None:
    ...
    models.append(('Exp_Smoothing', ExponentialSmoothing(trend="mul", seasonal="multiplicative", sp=4)))
    ...
    def select_regressor(selection):
        ...
        'Exp_Smoothing_Small': ExponentialSmoothing(trend="mul", seasonal="multiplicative", sp=4),
